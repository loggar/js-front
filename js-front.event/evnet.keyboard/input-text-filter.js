/**
 * inut-text-filter.js: unobtrusive filtering of keystrokes for <input> elements
 *
...
whenReady(function() {
  ...
  function filter(event) {
    ...
    if (e.type === "textinput" || e.type === "textInput") text = e.data;
      ...
      // This was a legacy keypress event
    ...
    if (messageid)
      // If there is a message id, get the element
      var messageElement = document.getElementById(messageid);
    // Loop through the characters of the input text
    for (var i = 0; i < text.length; i++) {
      var c = text.charAt(i);
      if (allowed.indexOf(c) == -1) {
        // Is this a disallowed character?
